...
{
    public class ES_MessagesMapping
    {
        public ES_MessagesMapping()
        {
            ...
            mappings._doc.properties = new ES_Mappings.ES_Doc.ES_Properties() {
                Text = new ES_Mappings.ES_Doc.ES_Properties.ES_SearchableType() { type = "text" },
                UtcDateTime = new ES_Mappings.ES_Doc.ES_Properties.ES_DateType() { type = "date", format = "strict_date_time" },
                Day = new ES_Mappings.ES_Doc.ES_Properties.ES_SearchableType() { type = "integer" },
        ...
        public class ES_Mappings
        {
            ...
            public class ES_Doc
            {
                ...
                {
                    public ES_SearchableType Text { get; set; }
